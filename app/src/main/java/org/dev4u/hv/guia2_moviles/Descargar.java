...
public class Descargar extends AsyncTask<String, Integer, Estado> {
    ...
    private RadioButton rdbtnCambiar;
    private ProgressBar prbPorgreso;
    private EditText txbNombre;
    private Context context;



    public Descargar(Context context,TextView estado,Button descargar, RadioButton cambiar, ProgressBar prbPorgress, EditText txbName) {
        this.context      = context;
        this.lblEstado    = estado;
        this.btnDescargar = descargar;
        this.rdbtnCambiar = cambiar;
        this.prbPorgreso = prbPorgress;
        this.txbNombre = txbName;
    }
    ...
    protected Estado doInBackground(String... sUrl) {
        ...
        try {
            ...
            if(rdbtnCambiar.isChecked()){
                nombre = this.txbNombre.getText().toString();
            }else{
                nombre = url.getFile();
            }
    ...
    protected void onProgressUpdate(Integer... progress) {//esto ocurre mientras se descarga
        ...
        prbPorgreso.setProgress(progress[0]);
    }
